//create noch überall ändern 
// ca_msgs wurde schon zu r_msgs geändert.
...
#include "create/create.h"
 // wo ist diese Datei?! in: /home/markus/catkin_ws/devel/src/libcreate/include/create
#include "r_msgs/ChargingState.h"
#include "r_msgs/Mode.h"
#include "r_msgs/Bumper.h"
#include "r_msgs/My.h" //<< diese dateien befinden sich in devel/include/ca_msgs 
...
private:
  ...
  r_msgs::Mode mode_msg_;
  r_msgs::ChargingState charging_state_msg_;
  r_msgs::Bumper bumper_msg_;
  // my own message:
  r_msgs::My my_msg_;	
  ...
  std_msgs::Float32 float32_msg_; // das ist eine Instanz vom Message typ Float32
  ...
  void soundCallback(const std_msgs::UInt8MultiArrayConstPtr& msg); // Sound
  void mySongCallback(const std_msgs::BoolConstPtr& msg); // mySong
...
protected:
  ...
  ros::Subscriber sound_; // mySound subscriber
  ros::Subscriber mySong_; // my custom song
